...
def blog_show(request, id=''):
    try:
        ...
        raise Http404
    return render_to_response("blog/blog_show.html", {"blog": blog}, context_instance=RequestContext(request))
...
def blog_show_comment(request, id=''):
    blog = Blog.objects.get(id=id)
    return render_to_response('blog/blog_comments_show.html', {"blog": blog}, context_instance=RequestContext(request))
